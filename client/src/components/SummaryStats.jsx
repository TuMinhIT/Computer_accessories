    ...
    return (
        ...
        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                {[
                    { label: 'Tổng tiền', value: `$${stats.totalRevenue.toFixed(2)}`, color: 'indigo-700' },
                    { label: 'Số đơn hàng', value: stats.orderCount, color: 'indigo-700' },
                    { label: 'Số sản phẩm', value: stats.productCount, color: 'indigo-700' },
                    { label: 'Lợi nhuận', value: `$${stats.profit.toFixed(2)}`, color: 'green-600' },
                ].map((stat, index) => (
                    <motion.div
                        key={index}
